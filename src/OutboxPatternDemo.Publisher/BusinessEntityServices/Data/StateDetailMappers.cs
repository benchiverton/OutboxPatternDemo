...
public static class StateDetailMappers
{
    ...
    public static StateDetail ToStateDetail(this StateDetailDto stateDetailDto)
        => new StateDetail(stateDetailDto.Id, stateDetailDto.State, stateDetailDto.TimeStampUtc);
}
